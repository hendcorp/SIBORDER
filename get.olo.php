...
header("Content-Disposition: attachment; filename=OLO_".$_GET['witel'].".xls");

include "config/connect.php";

if($_GET['tipe']=='order')
{
  $QueStat = " (STAT_SERVICE IS NULL OR STAT_SERVICE IS NOT NULL) ";
}
...
$sql = OCIParse($connect, "SELECT * FROM SB_OLO WHERE".$QueStat."AND".$qwitel);
ociexecute($sql);
