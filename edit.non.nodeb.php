...
<html lang="en">
  <head>
    ...
    <title>Si Border - Update TSEL Non Node B</title>
...
<div class="panel-heading">
    <h3 class="panel-title"><strong>FORM UPDATE TSEL NON NODE B</strong></h3>
</div>
...
<div class="panel panel-danger">
<div class="panel-heading">
    <h3 class="panel-title"><strong>DETIL DATA TSEL NON NODE B</strong></h3>
</div>
<div class="panel-body"><br />
<table class="table table-bordered">
<tr>
  <td width="20%">DASAR ORDER</td>
