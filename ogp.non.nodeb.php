...
<html lang="en">
  <head>
    ...
    <title>Si Border - Report On Going Project Non Node B</title>
...
$sql = OCIParse($connect,"SELECT WITEL, DASAR_ORDER, JENIS, PRODUCT, CONCAT(KAPS, SAT) AS BW, RUAS, ID FROM SB_NON_NODE_B WHERE STATUS = 'OPEN' AND".$qwit);
ociexecute($sql);

$wit = OCIParse($connect, "SELECT DISTINCT WITEL FROM SB_NON_NODE_B ORDER BY WITEL");
ociexecute($wit);
?>
<div class="container">
<h3 align="center"><strong>REPORT ON GOING PROJECT TSEL NON NODE B</strong></h3><br />
...
<p align="right"><a href="get.ogp.non.nodeb.php" style="text-decoration:none"><font color="green"><strong><i class="fa fa-file-excel-o"></i> EXPORT TO EXCEL</strong></font></a></p>
</div>
</div>
<hr />
...
<div class="col-md-12">
  ...
  <tr>
    <?php if($_SESSION['privilege']!='guest') { ?>
    <td align="center"><a href="edit.ogp.non.nodeb.php?id=<?php echo $row[6]; ?>" style="text-decoration:none"><font color="#E12E32"><i class="fa fa-pencil"></i></font></a></td>
    <?php } ?>
